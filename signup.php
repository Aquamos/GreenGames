        	    ...
        	    <div class="header__right">
        			...
        			<li class="languages">
        				...
        				<ul class="languages_subnav">
        					<li>
        						<a class="languages__link" href="signup.php?lang=ru"><?php echo $lang["lang_ru"]?></a>
        					</li>
        					<li>
        						<a class="languages__link" href="signup.php?lang=ua"><?php echo $lang["lang_ua"]?></a>
        					</li>
        					<li>
        						<a class="languages__link" href="signup.php?lang=en"><?php echo $lang["lang_en"]?></a>
        					</li>
        				</ul>
        			</li>
